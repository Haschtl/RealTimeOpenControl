...
class Actions:
    ...
    def systemTrayClickAction(self, reason):
        ...
        #     print("middleclick")
        # else:
        #     print("unknown reason: "+str(reason))
    ...
    def toggleLanguage(self, newlang, button, otherbuttons, force = False):
        ...
        if newlang != self.config["language"] or force == True:
            ...
            if force == False:
                pyqtlib.info_message(self.tr("Sprache geändert"), self.tr("Bitte Programm neustarten"), "")
