...
buildOptions = dict(packages = ["nmap","telegram", "telegram.ext", "matplotlib", "getopt", "numpy","scipy","sys","os","time", "traceback", "multiprocessing", "json", "csv", "xlsxwriter", "importlib", "threading", "collections", "functools", "math", "random", "PyQt5", "pyqtgraph", 'lxml._elementpath','lxml.etree',"markdown2", "idna.idnadata", "idna"]+pluginimports, excludes = ["scipy.spatial.cKDTree"], includes = ["RTOC/","RTOC/LoggerPlugin", "RTOC/RTLogger/scriptLibrary"], include_files = ["RTOC/", "RTOC/data/","RTOC/data/icon.png","example_scripts/","RTOC/plugins/","avbin64.dll","README.md","LICENSE", r"C:\Users\hasch\AppData\Local\Programs\Python\Python36\DLLs\tcl86t.dll",
