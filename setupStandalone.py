...
buildOptions = dict(packages = ["nmap","telegram", "telegram.ext", "matplotlib", "getopt", "numpy","scipy","sys","pandas","os","time", "traceback", "multiprocessing", "json", "csv", "xlsxwriter", "ezodf","importlib", "threading", "collections", "functools", "math", "random", "PyQt5", "pyqtgraph", 'lxml._elementpath','lxml.etree', 'whaaaaat', "markdown2", 'Cryptodome',"github", "idna.idnadata", "idna",'dash_table','dash','gevent', 'plotly','dash_daq','flask']+pluginimports, excludes = ["scipy.spatial.cKDTree"], includes = ["RTOC/","RTOC/LoggerPlugin", "RTOC/RTLogger/scriptLibrary"], include_files = ["RTOC/", "RTOC/data/","RTOC/data/icon.png","example_scripts/","RTOC/RTLogger/plugins/","RTOC/RTLogger/","RTOC/RTOC_GUI/", "avbin64.dll","README.md","LICENSE", r"C:\Users\hasch\AppData\Local\Programs\Python\Python36\DLLs\tcl86t.dll",
